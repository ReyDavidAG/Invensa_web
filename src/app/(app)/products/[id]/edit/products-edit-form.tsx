...
/* Hallmark · locked system applied · src/app/(app)/products/[id]/edit/products-edit-form.tsx
 * Edit form for an existing product. Same shape as the new form, but bound
 * to useUpdateProduct(id) and pre-populated with the current values.
 * Every control disables while a mutation is in-flight; success/error
 * surfaces via Sonner toasts.
 */
